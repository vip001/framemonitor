...
class SnackbarManager {
    ...
    private static SparseArray<SnackbarManager> mSnackbarManagerArray = new SparseArray<>();


    static SnackbarManager getInstance(int type) {
        SnackbarManager manager = mSnackbarManagerArray.get(type);
        if (manager == null) {
            manager = new SnackbarManager(type);
            mSnackbarManagerArray.put(type, manager);
        }
        return manager;
    }
    ...
    private SnackbarManager(int type) {
        mLock = new Object();
    ...
    public void onDismissed(Callback callback) {
        ...
        mSnackbarManagerArray.remove(mType);
    }
