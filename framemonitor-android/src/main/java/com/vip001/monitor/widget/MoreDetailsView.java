...
public final class MoreDetailsView extends View {
    ...
    public MoreDetailsView(Context context, AttributeSet attrs) {
        ...
        float strokeSize = resources.getDimensionPixelSize(R.dimen.monitor_more_stroke_width);
        iconPaint.setStrokeWidth(strokeSize);

        // This lint check doesn't work for libraries which have a common prefix.
        @SuppressLint("CustomViewStyleable") //
                TypedArray a =
                context.obtainStyledAttributes(attrs, R.styleable.monitor_MoreDetailsView);
        int plusColor =
                a.getColor(R.styleable.monitor_MoreDetailsView_monitor_plus_color, Color.BLACK);
        a.recycle();
