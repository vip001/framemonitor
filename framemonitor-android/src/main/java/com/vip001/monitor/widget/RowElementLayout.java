...
public class RowElementLayout extends ViewGroup {
    ...
    public RowElementLayout(Context context, AttributeSet attrs) {
        ...
        connectorWidth = resources.getDimensionPixelSize(R.dimen.monitor_connector_width);
        rowMargins = resources.getDimensionPixelSize(R.dimen.monitor_row_margins);
        moreSize = resources.getDimensionPixelSize(R.dimen.monitor_more_size);
        minHeight = resources.getDimensionPixelSize(R.dimen.monitor_row_min);
        titleMarginTop = resources.getDimensionPixelSize(R.dimen.monitor_row_title_margin_top);
        moreMarginTop = resources.getDimensionPixelSize(R.dimen.monitor_more_margin_top);
    }

    @Override
    protected void onFinishInflate() {
        super.onFinishInflate();
        connector = findViewById(R.id.row_connector);
        moreButton = findViewById(R.id.row_more);
        title = findViewById(R.id.row_title);
        details = findViewById(R.id.row_details);
    }
