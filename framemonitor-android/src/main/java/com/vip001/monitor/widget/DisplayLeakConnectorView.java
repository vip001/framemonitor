...
public final class DisplayLeakConnectorView extends View {
    ...
    public DisplayLeakConnectorView(Context context, AttributeSet attrs) {
        ...
        circleY = resources.getDimensionPixelSize(R.dimen.monitor_connector_center_y);
        strokeSize = resources.getDimensionPixelSize(R.dimen.monitor_connector_stroke_size);

        classNamePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        classNamePaint.setColor(resources.getColor(R.color.monitor_class_name));
        classNamePaint.setStrokeWidth(strokeSize);

        leakPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        leakPaint.setColor(resources.getColor(R.color.monitor_leak));
        leakPaint.setStyle(Paint.Style.STROKE);
        leakPaint.setStrokeWidth(strokeSize);
        float pathLines = resources.getDimensionPixelSize(R.dimen.monitor_connector_leak_dash_line);
        float pathGaps = resources.getDimensionPixelSize(R.dimen.monitor_connector_leak_dash_gap);
        ...
        referencePaint.setColor(resources.getColor(R.color.monitor_reference));
